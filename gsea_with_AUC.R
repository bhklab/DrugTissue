...
save(combined1, file = paste(path.data, "auc only p values 10k global adjust.RData", sep = "/"))
save(combined2, file = paste(path.data, "auc only p values 10k local adjust.RData", sep = "/"))
